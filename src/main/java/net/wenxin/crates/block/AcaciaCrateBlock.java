...
public class AcaciaCrateBlock extends CratesModElements.ModElement implements IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	@ObjectHolder("crates:acacia_crate")
	public static final Block block = null;
	@ObjectHolder("crates:acacia_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AcaciaCrateBlock(CratesModElements instance) {
		super(instance, 9);
