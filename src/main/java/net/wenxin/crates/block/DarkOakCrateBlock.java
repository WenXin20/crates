...
public class DarkOakCrateBlock extends CratesModElements.ModElement implements IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	@ObjectHolder("crates:dark_oak_crate")
	public static final Block block = null;
	@ObjectHolder("crates:dark_oak_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DarkOakCrateBlock(CratesModElements instance) {
		super(instance, 11);
