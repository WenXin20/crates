...
public class JungleCrateBlock extends CratesModElements.ModElement implements IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	@ObjectHolder("crates:jungle_crate")
	public static final Block block = null;
	@ObjectHolder("crates:jungle_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public JungleCrateBlock(CratesModElements instance) {
		super(instance, 7);
