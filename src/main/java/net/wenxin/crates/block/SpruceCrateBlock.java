...
public class SpruceCrateBlock extends CratesModElements.ModElement implements IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	@ObjectHolder("crates:spruce_crate")
	public static final Block block = null;
	@ObjectHolder("crates:spruce_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SpruceCrateBlock(CratesModElements instance) {
		super(instance, 3);
