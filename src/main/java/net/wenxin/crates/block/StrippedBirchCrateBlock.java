...
public class StrippedBirchCrateBlock extends CratesModElements.ModElement implements IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	@ObjectHolder("crates:stripped_birch_crate")
	public static final Block block = null;
	@ObjectHolder("crates:stripped_birch_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public StrippedBirchCrateBlock(CratesModElements instance) {
		super(instance, 6);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("stripped_birch_crate"));
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_birch_crate");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Stripped Birch Crate");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("stripped_birch_crate");
		}
