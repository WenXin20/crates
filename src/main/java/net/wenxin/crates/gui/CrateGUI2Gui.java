...
public class CrateGUI2Gui extends CratesModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CrateGUI2Gui(CratesModElements instance) {
		super(instance, 105);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("crate_gui_2"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 8, 35) {
			}));
			...
			this.customSlots.put(22, this.addSlot(new SlotItemHandler(internal, 22, 8, 53) {
			}));
			this.customSlots.put(23, this.addSlot(new SlotItemHandler(internal, 23, 26, 53) {
			}));
			this.customSlots.put(24, this.addSlot(new SlotItemHandler(internal, 24, 44, 53) {
			}));
			this.customSlots.put(25, this.addSlot(new SlotItemHandler(internal, 25, 62, 53) {
			}));
			this.customSlots.put(26, this.addSlot(new SlotItemHandler(internal, 26, 80, 53) {
			}));
			this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 98, 53) {
			}));
			this.customSlots.put(28, this.addSlot(new SlotItemHandler(internal, 28, 116, 53) {
			}));
			this.customSlots.put(29, this.addSlot(new SlotItemHandler(internal, 29, 134, 53) {
			}));
			this.customSlots.put(30, this.addSlot(new SlotItemHandler(internal, 30, 152, 53) {
			}));
			this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 170, 53) {
			}));
			this.customSlots.put(32, this.addSlot(new SlotItemHandler(internal, 32, 188, 53) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("crates:textures/crate_gui_2.png");
		@Override
