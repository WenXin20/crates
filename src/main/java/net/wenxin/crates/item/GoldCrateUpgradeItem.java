...
public class GoldCrateUpgradeItem extends CratesModElements.ModElement {
	@ObjectHolder("crates:gold_crate_upgrade")
	public static final Item block = null;
	public GoldCrateUpgradeItem(CratesModElements instance) {
		super(instance, 54);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("gold_crate_upgrade");
		}
